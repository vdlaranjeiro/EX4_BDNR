...
def read_usuario(session):
    ...
    if not usuarios:
        ...
        for favorito in favoritos:
            ...
            print(f"\nID: {favorito['fav_id']}")
            print(f"Produto: {favorito['fav_nome']}")
            print(f"Descricao: {favorito['fav_descricao']}")
            print(f"Quantidade: {favorito['fav_valor']}")

        print("\nCompras:")
        for compra in compras:
            compra = compra._asdict()
            print(f"\nID: {compra['comp_id']}")
            print(f"Produto: {compra['comp_prod_nome']}")
            print(f"Descricao: {compra['comp_prod_descricao']}")
            print(f"Quantidade: {compra['comp_prod_quantidade']}")
            print(f"Valor: {compra['comp_valor']}")
            print(f"Data: {compra['comp_data']}")
